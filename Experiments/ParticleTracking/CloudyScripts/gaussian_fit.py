# -*- coding: utf-8 -*-
"""
Created on Thu Jul 17 11:54:27 2014

This is the nicely-written Gaussian fit function from Tiago Pereira, from
https://github.com/tiagopereira/python_tips/blob/master/code/gaussian_fit.py
...
def gauss_lsq(x,y,verbose=False,itmax=200,iparams=[]):
    ...
    def _gauss_fjb(B,x):
        ...
        g = gaussian(B,x) #cache the Gaussian.  Should profile to see if it helps...
        _ret = N.concatenate(( -2*(x-B[0])*g,\
                             ((x-B[0])**2/(2*B[1]**2)-1)/B[1]*g,\
                             g/B[2] ,\
